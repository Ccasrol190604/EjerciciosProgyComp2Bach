package capitulo04_Ejemplo09_WindowBuilderCompleto;
...
public class Ejercicio01_FormularioSuperhéroe {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ejercicio01_FormularioSuperhéroe window = new Ejercicio01_FormularioSuperhéroe();
	 ...
	 */
	public Ejercicio01_FormularioSuperhéroe() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblNewLabel_2 = new JLabel("Tipo de crypto:");
